...
function checkCoverage() {
    ...
    setTimeout(() => {
        ...
        const bradfordAreas = ['BD', 'LS', 'HX', 'HD', 'WF', 'YO'];
        const extendedAreas = ['M', 'BL', 'OL', 'PR', 'BB', 'FY'];
        
        if (bradfordAreas.includes(area)) {
            showResult(
                `✅ Great news! We provide home visits to ${postcode}.<br>
                <strong>📞 Call us now:</strong> 0800 XXX XXXX<br>
            ...
            showResult(
                ...
                <strong>Please call us to confirm:</strong> 0800 XXX XXXX<br>
